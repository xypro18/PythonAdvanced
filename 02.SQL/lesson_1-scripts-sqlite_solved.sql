...
-- Answer: select *  from zoo where animal = 'zebra' limit 3;
...
-- Answer: select * from zoo where animal = 'zebra' and (water_need > 220 or id < 1012);
...
-- We could create indexes on the other categorical columns as well, but that would take too long.
